...
class BeritaInternasionalPage extends StatefulWidget {
  @override
  _BeritaInternasionalPageState createState() => _BeritaInternasionalPageState();
}

class _BeritaInternasionalPageState extends State<BeritaInternasionalPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Republika Internasional'),
